...
public class classifierTester {
    public static void main(String[] args) throws IOException {
        ...
        testingPerceptron("earthquake-clean.data.txt", .95, 700);
        testingLogistic("earthquake-clean.data.txt", 0.95, 5000);

        // //b -> noisy, any step, constant alpha
        testingPerceptron("earthquake-noisy.data.txt", 0.95, 100000);
        testingLogistic("earthquake-noisy.data.txt", 0.95, 100000);
        ...
        testingPerceptron("house-votes-84.data.num.txt", 0.95, 700);
        testingLogistic("house-votes-84.data.num.txt", 0.95, 5000);

        // //b -> Big amount of updates, constant alpha
        testingPerceptron("house-votes-84.data.num.txt", 0.95, 100000);
        testingLogistic("house-votes-84.data.num.txt", 0.95, 100000);
    ...
    public static void testingPerceptron(String filename, double alp, int updateNum) throws IOException{
    ...
    public static void testingLogistic(String filename, double alp, int updateNum) throws IOException{
        readData data = new readData(filename);
        ArrayList<Example> dataSet = data.readEarthOrHouseData(filename);
